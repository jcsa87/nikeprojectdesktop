namespace nikeproject
{
    partial class ClienteControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvCliente.Columns.AddRange(new DataGridViewColumn[] { Nombre, Apellido, Documento, Estado, idClienteDataGridViewTextBoxColumn, estadoDataGridViewCheckBoxColumn, fechaCreacionDataGridViewTextBoxColumn });
